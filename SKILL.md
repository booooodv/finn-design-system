---
name: personal-ip-design-system
description: 个人IP设计系统。做HTML页面、个人网站、教程页面、介绍页面、landing page等任何前端设计时自动触发。包含品牌DNA、头像规范和多个场景子规范。
---
...
### Step 2: 读规范
1. **必读** `brand-dna.md` — 确认品牌底层规范和默认 IP 头像
2. 根据类型选读场景文件：
